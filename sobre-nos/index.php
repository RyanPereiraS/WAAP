...
<body>
  ...
  <div class="container marketing">
    ...
    <div class="row">
      <!-- /.col-lg-4 -->
      <div class="col-lg-4">
        <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="profiles/1.png" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false">
        ...
        <p><a class="icons" href="https://github.com/RyanPereiraS" target="_newblank">
            <ion-icon name="logo-github"></ion-icon>
          </a> <a class="icons instagram" href="https://www.instagram.com/ryan.pereirasilva/" target="_newblank">
            <ion-icon name="logo-instagram"></ion-icon>
          </a> <a class="icons instagram" href="https://twitter.com/PereiraRyanS" target="_newblank">
            <ion-icon name="logo-twitter"></ion-icon>
          </a></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
        <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="profiles/5.png" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false">
        <title>Placeholder</title>
        <rect width="100%" height="100%" fill="#777" /></img>

        <h2>Bryan Palácio</h2>
        <p>And lastly this, the third column of representative placeholder content.</p>
        <p><a class="icons" href="#">
            <ion-icon name="logo-github"></ion-icon>
          </a> <a class="icons instagram" href="#">
            <ion-icon name="logo-instagram"></ion-icon>
          </a> <a class="icons instagram" href="#">
            <ion-icon name="logo-twitter"></ion-icon>
          </a></p>
      ...
      <div class="col-lg-4">
        <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="profiles/4.png" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false">
        <title>Placeholder</title>
        <rect width="100%" height="100%" fill="#777" /></img>
        <h2>Raul Germano</h2>
        <p>And lastly this, the third column of representative placeholder content.</p>
      ...
      <div class="col-lg-4 seglinha">
        <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="profiles/3.png" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false">
        <title>Placeholder</title>
        <rect width="100%" height="100%" fill="#777" /></img>
        <h2>Rafael Neves</h2>
        <p>And lastly this, the third column of representative placeholder content.</p>
      ...
      <div class="col-lg-4 seglinha">
        <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="profiles/6.png" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false">
        <title>Placeholder</title>
        <rect width="100%" height="100%" fill="#777" /></img>
        <h2>Vitor Leon</h2>
